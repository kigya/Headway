...
- Branch and task parsing: same rules as [.ai/cursor/skills/commit/SKILL.md](../commit/SKILL.md) steps 3–4 (task `<NUMBER>`, branch kind among `fullstack-headway`, `server-headway`, `client-headway`).
