...
$CURSOR_FILE   = Join-Path $REPO_ROOT '.ai/cursor/rules/specify-rules.mdc'
...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.ai/specify/templates/agent-file-template.md'
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Run specify init to scaffold .ai/specify/templates, or add agent-file-template.md there.'
        exit 1
    }
}
