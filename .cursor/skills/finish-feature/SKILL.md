...
2. **Critical rules (2–6 bullets only):** Pick the most relevant points from [.cursor/rules/global.mdc](../../rules/global.mdc), [.cursor/rules/client.mdc](../../rules/client.mdc) or [.cursor/rules/server.mdc](../../rules/server.mdc), [.cursor/rules/detekt-guardrails.mdc](../../rules/detekt-guardrails.mdc). Cite [.cursor/rules/lessons-learned.mdc](../../rules/lessons-learned.mdc) only when a lesson clearly matches the change.
...
5. **Lessons file bloat:** Read [.cursor/rules/lessons-learned.mdc](../../rules/lessons-learned.mdc). Count lessons (`### N` sections). **Bloat if** count **> 12** **or** **≥ 3** lessons cluster on one theme, e.g. Freud/Material3, ViewModel vs Store, navigation/NavigatorContract, gateway/`upstreamCall`, detekt/style, client `Outcome`.
