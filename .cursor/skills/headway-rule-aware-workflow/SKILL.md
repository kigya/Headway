...
2. Load matching Cursor rules from [.cursor/rules/](../../rules/):
...
3. Prefer **existing** project patterns over inventing new ones; treat [lessons-learned.mdc](../../rules/lessons-learned.mdc) as cumulative anti-patterns to avoid.
